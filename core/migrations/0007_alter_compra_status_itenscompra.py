...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0006_statuscompra_alter_compra_status'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='compra',
            name='status',
            field=models.ForeignKey(default=models.SET(core.models.get_StatusCompra_user), on_delete=django.db.models.deletion.PROTECT, related_name='compra', to='core.statuscompra'),
        ),
